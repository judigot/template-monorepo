...
type ITextProfileField = Exclude<
  ...
  'deliveryPreference' | 'emailNotifications' | 'termsAccepted' | 'tags'
>;
    ...
    <>
      ...
      >
        <header className="ui-form-header">
          ...
          <p>Complete each section to create a production-ready profile.</p>
        </header>

        <div className="ui-form-grid">
          <fieldset className="ui-form-section ui-form-field--full">
            <legend className="ui-form-legend">Identity</legend>
            <div className="ui-form-grid">
              ...
              <label className="ui-form-field" htmlFor="profile-avatar">
                <span className="ui-form-label">Profile image</span>
                <input
          ...
          <fieldset className="ui-form-section ui-form-field--full">
            <legend className="ui-form-legend">Contact and availability</legend>
            <div className="ui-form-grid">
              <label
          ...
          <fieldset className="ui-form-section ui-form-field--full">
            <legend className="ui-form-legend">Preferences</legend>
            <div className="ui-form-grid">
              ...
              <div className="ui-switch ui-form-field--full">
                <Label.Root htmlFor="profile-email-notifications">
